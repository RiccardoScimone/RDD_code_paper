...
names(err_data)[5:8] = c("lambda[1]" ,"lambda[2]","theta[deg]","tau")
...
names(errors_convo)[3:5] = c("lambda[1]" ,"lambda[2]","theta[deg]")
...
errors_Fou = errors_Fou %>% mutate_at(c("lambda_1","lambda_2","sigma","tau"), exp)

names(errors_Fou)[3:5] = c("lambda[1]" ,"lambda[2]","theta[deg]")
...
err_data_summarises$pars %<>% factor(levels = 
                                       c("mu","sigma","lambda[1]","lambda[2]","theta[deg]","phi","tau"))

errors_Fou$pars %<>% factor(levels = 
                                       c("mu","sigma","lambda[1]","lambda[2]","theta[deg]","phi","tau"))
