...
model = stan_model("simulazioni.stan")
...
fit = sampling(object = model_fitting, data=data,
               warmup=1000, iter=2000, chains=4, seed=18011996, refresh=10,sample_file = "chain_data.csv")
saveRDS(fit,"fit.rds")
#cm_fit_fit = cm_model_fitting$sample(data = data, chains = 1, parallel_chains = 1, fixed_param = F,iter_warmup = 1000,iter_sampling = 1000,opencl_ids = c(0, 0), refresh = 10)
